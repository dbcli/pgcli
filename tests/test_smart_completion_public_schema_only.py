...
@parametrize('completer', completers(casing=False))
@parametrize('text', [
    'SELECT * FROM users u1 JOIN users u2 USING (email) JOIN user_emails ue '
    'USING()',

    'SELECT * FROM users u1 JOIN users u2 USING(email) JOIN user_emails ue '
    'USING ()',

    'SELECT * FROM users u1 JOIN user_emails ue USING () JOIN users u2 ue '
